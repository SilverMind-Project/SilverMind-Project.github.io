...
| MCP tool server | 59 tools (read-only queries plus rule triggering, rule authoring, guided-session control, signal acknowledgment, and interactive response recording). |
